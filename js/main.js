// --- HERO SEQUENCE LOGIC ---
        ...
        const workItems = [
            ...
            { id: 6, title: "YG Gentlemen's Club", director: 'Brandon Almengo', category: 'commercials', categoryLabel: 'Commercial Campaign', image: 'assets/images/yg-gentlemens-club.png', video: null, link: 'yg-gentlemens-club.html' },
            ...
            { id: 7, title: "love? ...or something like it", director: 'Halle · Brandon Almengo', category: 'album-covers', categoryLabel: 'Album Cover', image: 'assets/images/album-covers/album-01.png', video: null, link: '#', square: true },
            { id: 8, title: 'Keep It Lit', director: 'Kamaiyah · Brandon Almengo', category: 'album-covers', categoryLabel: 'Album Cover', image: 'assets/images/album-covers/album-02.png', video: null, link: '#', square: true },
            { id: 9, title: 'On God', director: 'Koryn Hawthorne · Brandon Almengo', category: 'album-covers', categoryLabel: 'Album Cover', image: 'assets/images/album-covers/album-03.png', video: null, link: '#', square: true },
            { id: 10, title: 'Fine Ho, Stay', director: 'Flo Milli · Brandon Almengo', category: 'album-covers', categoryLabel: 'Album Cover', image: 'assets/images/album-covers/album-04.png', video: null, link: '#', square: true },
            { id: 11, title: "First Lady of the Mob", director: 'Kamaiyah & DJ Idea · Brandon Almengo', category: 'album-covers', categoryLabel: 'Album Cover', image: 'assets/images/album-covers/album-05.png', video: null, link: '#', square: true },
            { id: 12, title: 'Trouble in Paradise', director: 'Chlöe Bailey · Brandon Almengo', category: 'album-covers', categoryLabel: 'Album Cover', image: 'assets/images/album-covers/album-06.png', video: null, link: '#', square: true },
            { id: 13, title: 'Before We Party', director: 'Kamaiyah · Brandon Almengo', category: 'album-covers', categoryLabel: 'Album Cover', image: 'assets/images/album-covers/album-07.png', video: null, link: '#', square: true },
            { id: 14, title: 'Drunken Words Sober Thoughts', director: 'Seven · Brandon Almengo', category: 'album-covers', categoryLabel: 'Album Cover', image: 'assets/images/album-covers/album-08.png', video: null, link: '#', square: true },
            { id: 15, title: 'No Explanations', director: 'Kamaiyah · Brandon Almengo', category: 'album-covers', categoryLabel: 'Album Cover', image: 'assets/images/album-covers/album-09.png', video: null, link: '#', square: true },
            { id: 16, title: "It's On", director: 'Rubi Rose · Brandon Almengo', category: 'single-covers', categoryLabel: 'Single Cover', image: 'assets/images/single-covers/single-01.jpg', video: null, link: '#', square: true },
            { id: 17, title: 'Go Loko', director: 'YG, Tyga, Jon Z · Brandon Almengo', category: 'single-covers', categoryLabel: 'Single Cover', image: 'assets/images/single-covers/single-02.jpg', video: null, link: '#', square: true },
            { id: 18, title: 'Best Friend', director: 'Saweetie ft. Doja Cat · Brandon Almengo', category: 'single-covers', categoryLabel: 'Single Cover', image: 'assets/images/single-covers/single-03.jpg', video: null, link: '#', square: true },
            { id: 19, title: 'Never Lose Me', director: 'Flo Milli · Brandon Almengo', category: 'single-covers', categoryLabel: 'Single Cover', image: 'assets/images/single-covers/single-04.jpg', video: null, link: '#', square: true },
            { id: 20, title: 'Splash', director: 'Tyga feat. Moneybagg Yo · Brandon Almengo', category: 'single-covers', categoryLabel: 'Single Cover', image: 'assets/images/single-covers/single-05.jpg', video: null, link: '#', square: true },
            { id: 21, title: 'Guilty', director: 'Sevyn Streeter, Chris Brown, A$AP Ferg · Brandon Almengo', category: 'single-covers', categoryLabel: 'Single Cover', image: 'assets/images/single-covers/single-06.jpg', video: null, link: '#', square: true },
            { id: 22, title: 'No Face', director: 'Ghostface Killah & Kanye West · Brandon Almengo', category: 'single-covers', categoryLabel: 'Single Cover', image: 'assets/images/single-covers/single-07.jpg', video: null, link: '#', square: true },
            { id: 23, title: 'Tap In', director: 'Saweetie · Brandon Almengo', category: 'single-covers', categoryLabel: 'Single Cover', image: 'assets/images/single-covers/single-08.jpg', video: null, link: '#', square: true },
            { id: 24, title: 'Do It', director: 'Chloe x Halle · Brandon Almengo', category: 'single-covers', categoryLabel: 'Single Cover', image: 'assets/images/single-covers/single-09.jpg', video: null, link: '#', square: true },
            { id: 25, title: 'Too Fine', director: 'Flo Milli · Brandon Almengo', category: 'single-covers', categoryLabel: 'Single Cover', image: 'assets/images/single-covers/single-10.jpg', video: null, link: '#', square: true },
            { id: 26, title: 'Ibiza', director: 'Tyga · Brandon Almengo', category: 'single-covers', categoryLabel: 'Single Cover', image: 'assets/images/single-covers/single-11.jpg', video: null, link: '#', square: true },
            { id: 27, title: 'Conceited', director: 'Flo Milli · Brandon Almengo', category: 'single-covers', categoryLabel: 'Single Cover', image: 'assets/images/single-covers/single-12.jpg', video: null, link: '#', square: true },
            { id: 28, title: 'The One', director: 'Stefflon Don · Brandon Almengo', category: 'single-covers', categoryLabel: 'Single Cover', image: 'assets/images/single-covers/single-13.jpg', video: null, link: '#', square: true },
            { id: 29, title: 'B.T.W', director: 'Flo Milli · Brandon Almengo', category: 'single-covers', categoryLabel: 'Single Cover', image: 'assets/images/single-covers/single-14.jpg', video: null, link: '#', square: true },
            { id: 30, title: 'Back and Forth', director: 'Halle · Brandon Almengo', category: 'single-covers', categoryLabel: 'Single Cover', image: 'assets/images/single-covers/single-15.jpg', video: null, link: '#', square: true },
            { id: 31, title: 'Look at God', director: 'Koryn Hawthorne · Brandon Almengo', category: 'single-covers', categoryLabel: 'Single Cover', image: 'assets/images/single-covers/single-16.jpg', video: null, link: '#', square: true },
        ];
